...
const ProductsPage = () => {
  ...
  // Handle product fetching with immediate first load and debounced updates
  useEffect(() => {
    const fetchFunc = () => {
      const params = {};
    ...
    if (isFirstRender.current) {
      ...
      const delayDebounce = setTimeout(fetchFunc, 500); // reduced to 500ms for snappier feel
  ...
  if (delayedLoading && (loading || categoryLoading)) {
    return <Loader />;
  }

  return (
    <PageContainer className="py-8">
      <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">Browse Products</h1>
      ...
      <div className="mb-8">
        ...
        {showFilters && (
          <div className="mt-4 p-4 border border-slate-200 dark:border-slate-800 rounded-lg bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">

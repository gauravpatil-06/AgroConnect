...
const CheckoutPage = () => {
  ...
  return (
    <PageContainer className="py-8">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center text-green-500 hover:text-green-700 mb-6 font-medium transition-colors"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-md p-6 mb-6">
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Your Cart</h2>
            ...
            <div className="border-t border-gray-200 dark:border-slate-700 pt-4">
              {cartItems.map((item) => (
                <div
                  key={item.productId}
                  className="flex flex-col sm:flex-row items-start sm:items-center justify-between py-4 border-b border-gray-200 dark:border-slate-700"
                >
                  <div className="flex items-center mb-2 sm:mb-0">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 font-medium text-sm">Rs. {item.price.toFixed(2)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    <div className="mr-4">
                      ...
                      <input
                        ...
                        min="1"
                        max={item.quantityAvailable || 999}
                        value={item.quantity}
                        onChange={(e) =>
                        ...
                        className="w-16 px-2 py-1 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-md pl-3 focus:outline-none focus:ring-2 focus:ring-green-500"
                      />
                    </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-md p-6">
